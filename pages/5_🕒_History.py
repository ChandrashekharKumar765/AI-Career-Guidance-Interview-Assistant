...
st.write("View your previous AI analysis and guidance.")
...
if resume_history:
    ...
    st.info("No Resume Analysis history available.")
...
career_history = get_career_history()
...
if career_history:
    ...
    for name, degree, skills, interest, guidance, created_at in career_history:
        ...
        with st.expander(
            ...
            st.write("**Career Interest:**", interest)
    ...
    st.info("No Career Guidance history available.")
...
interview_history = get_interview_history()
...
st.success(
    "✅ All activities are stored securely in the project database."
)